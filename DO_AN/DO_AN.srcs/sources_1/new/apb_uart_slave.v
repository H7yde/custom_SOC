module apb_uart_slave #(
    ...
    wire tx_write = UART_PSEL && UART_PENABLE && UART_PWRITE &&
                    (UART_PADDR[7:0] == 8'h00);
    assign UART_PREADY = !(tx_write && tx_busy);

    wire apb_write = UART_PSEL && UART_PENABLE && UART_PWRITE && UART_PREADY;
